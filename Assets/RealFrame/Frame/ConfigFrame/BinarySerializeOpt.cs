...
public class BinarySerializeOpt
{
    ...
    public static bool XmlSerialize(string path, System.Object obj)
    {
        ...
        {
            Debug.LogError("此类型无法转换成xml: " + obj.GetType() + "," + e);
        }
        return false;
    }
    ...
    public static T XmlDeserializeRun<T>(string path) where T : class
    {
        ...
        if (textAsset == null)
        {
            Debug.LogError("XmlDeserializeRun: can not load TextAsset: " + path);
            return null;
        }
        ...
        {
            Debug.LogError("XmlDeserializeRun: load TextAsset exception: " + path + "," + e);
        }
        return t;
    }
    ...
    public static T BinaryDeserialize<T>(string path) where T : class
    {
        ...
        if (textAsset == null)
        {
            Debug.LogError("BinaryDeserialize: can not load TextAsset: " + path);
            return null;
        }
        ...
        {
            Debug.LogError("BinaryDeserialize: load TextAsset exception: " + path + "," + e);
        }
        return t;
    }
}
